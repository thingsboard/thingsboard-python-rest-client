...
class DeviceInfo(object):
    ...
    def __init__(self, additional_info=None, created_time=None, customer_id=None, customer_is_public=None, customer_title=None, device_data=None, device_profile_id=None, device_profile_name=None, id=None, label=None, name=None, tenant_id=None, type=None):  # noqa: E501
