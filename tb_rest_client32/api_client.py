...
import tb_rest_client32.models.models_ce
import tb_rest_client32.models.models_pe
from tb_rest_client32 import rest
...
class ApiClient(object):
    ...
    def find_class(data, klass):
        try:
            found_class = getattr(tb_rest_client32.models.models_pe, klass)
            ...
            if all(attr in list(found_class.attribute_map.values()) for attr in list(data.keys())):
                ...
                found_class = getattr(tb_rest_client32.models.models_ce, klass)
                # if sorted(list(found_class.attribute_map.values())) == sorted(list(data.keys())):
                if all(attr in list(found_class.attribute_map.values()) for attr in list(data.keys())):
                    klass = found_class
        except AttributeError:
    ...
    def __deserialize_model(self, data, klass):
        ...
        if (hasattr(klass, 'swagger_types') and not klass.swagger_types and
                not self.__hasattr(klass, 'get_real_child_model')):
            return data

        kwargs = {}
        if hasattr(klass, 'swagger_types') and klass.swagger_types is not None:
