...
class SelfRegistrationControllerApi(object):
    ...
    def save_self_registration_params_using_post(self, self_registration_params, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_self_registration_params_using_post(self_registration_params, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.save_self_registration_params_using_post_with_http_info(self_registration_params, **kwargs)  # noqa: E501
        else:
            (data) = self.save_self_registration_params_using_post_with_http_info(self_registration_params, **kwargs)  # noqa: E501
            return data
    ...
    def save_self_registration_params_using_post_with_http_info(self, self_registration_params, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_self_registration_params_using_post_with_http_info(self_registration_params, async_req=True)
        >>> result = thread.get()
        ...
        if ('self_registration_params' not in params or
            ...
            raise ValueError("Missing the required parameter `self_registration_params` when calling `save_self_registration_params_using_post`")  # noqa: E501
