...
class DeviceControllerApi(object):
    ...
    def find_by_query_using_post1(self, query, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.find_by_query_using_post1(query, async_req=True)
        >>> result = thread.get()
    ...
    def find_by_query_using_post1_with_http_info(self, query, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.find_by_query_using_post1_with_http_info(query, async_req=True)
        >>> result = thread.get()
    ...
    def get_devices_by_entity_group_id_using_get_with_http_info(self, entity_group_id, page_size, page, **kwargs):  # noqa: E501
        ...
        if 'page_size' in params and params['page_size'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `get_devices_by_entity_group_id_using_get`, must be a value greater than or equal to `1`")  # noqa: E501
        if 'page' in params and params['page'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `get_devices_by_entity_group_id_using_get`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def save_device_credentials_using_post(self, device_credentials, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_device_credentials_using_post(device_credentials, async_req=True)
        >>> result = thread.get()
    ...
    def save_device_credentials_using_post_with_http_info(self, device_credentials, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_device_credentials_using_post_with_http_info(device_credentials, async_req=True)
        >>> result = thread.get()
    ...
    def save_device_using_post(self, device, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_device_using_post(device, async_req=True)
        >>> result = thread.get()
    ...
    def save_device_using_post_with_http_info(self, device, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_device_using_post_with_http_info(device, async_req=True)
        >>> result = thread.get()
