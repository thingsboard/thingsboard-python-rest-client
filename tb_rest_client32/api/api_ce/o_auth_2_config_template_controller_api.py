...
class OAuth2ConfigTemplateControllerApi(object):
    ...
    def save_client_registration_template_using_post(self, client_registration_template, **kwargs):  # noqa: E501
        """saveClientRegistrationTemplate  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_client_registration_template_using_post(client_registration_template, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param OAuth2ClientRegistrationTemplate client_registration_template: clientRegistrationTemplate (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.save_client_registration_template_using_post_with_http_info(client_registration_template, **kwargs)  # noqa: E501
        else:
            (data) = self.save_client_registration_template_using_post_with_http_info(client_registration_template, **kwargs)  # noqa: E501
            return data

    def save_client_registration_template_using_post_with_http_info(self, client_registration_template, **kwargs):  # noqa: E501
        """saveClientRegistrationTemplate  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_client_registration_template_using_post_with_http_info(client_registration_template, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['client_registration_template']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'client_registration_template' is set
        if ('client_registration_template' not in params or
                params['client_registration_template'] is None):
            raise ValueError("Missing the required parameter `client_registration_template` when calling `save_client_registration_template_using_post`")  # noqa: E501
        ...
        body_params = None
        if 'client_registration_template' in params:
            body_params = params['client_registration_template']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['*/*'])  # noqa: E501
