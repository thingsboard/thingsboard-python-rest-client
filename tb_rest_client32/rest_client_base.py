...
class RestClientBase(Thread):
    ...
    def add_dashboard_customers(self, dashboard_id: DashboardId, str_customer_ids, **kwargs):
        return self.dashboard_controller.add_dashboard_customers_using_post(dashboard_id, str_customer_ids, **kwargs)

    def assign_dashboard_to_customer(self, customer_id: CustomerId, dashboard_id: DashboardId, **kwargs):
        return self.dashboard_controller.assign_dashboard_to_customer_using_post(customer_id, dashboard_id, **kwargs)

    def assign_dashboard_to_public_customer(self, dashboard_id: DashboardId, **kwargs):
        return self.dashboard_controller.assign_dashboard_to_public_customer_using_post(dashboard_id, **kwargs)

    def delete_dashboard(self, dashboard_id: DashboardId, **kwargs):
        return self.dashboard_controller.delete_dashboard_using_delete(dashboard_id, **kwargs)

    def get_customer_dashboards(self, customer_id: CustomerId, page_size=100, page=0, **kwargs):
        return self.dashboard_controller.get_customer_dashboards_using_get(customer_id, str(page_size), str(page), **kwargs)

    def get_dashboard_by_id(self, dashboard_id: DashboardId, **kwargs):
        return self.dashboard_controller.get_dashboard_by_id_using_get(dashboard_id, **kwargs)

    def get_dashboard_info_by_id(self, dashboard_id: DashboardId, **kwargs):
        return self.dashboard_controller.get_dashboard_info_by_id_using_get(dashboard_id, **kwargs)
    ...
    def get_tenant_dashboards(self, tenant_id: TenantId, page_size=100, page=0, **kwargs):
        if tenant_id is not None:
            return self.dashboard_controller.get_tenant_dashboards_using_get1(tenant_id, str(page_size), str(page), **kwargs)
        else:
    ...
    def remove_dashboard_customers(self, dashboard_id: DashboardId, str_customer_ids, **kwargs):
        return self.dashboard_controller.remove_dashboard_customers_using_post(dashboard_id, str_customer_ids, **kwargs)
    ...
    def unassign_dashboard_from_customer(self, customer_id: CustomerId, dashboard_id: DashboardId, **kwargs):
        return self.dashboard_controller.unassign_dashboard_from_customer_using_delete(customer_id, dashboard_id, **kwargs)

    def unassign_dashboard_from_public_customer(self, dashboard_id: DashboardId, **kwargs):
        return self.dashboard_controller.unassign_dashboard_from_public_customer_using_delete(dashboard_id, **kwargs)

    def update_dashboard_customers(self, dashboard_id: DashboardId, str_customer_ids, **kwargs):
        return self.dashboard_controller.update_dashboard_customers_using_post(dashboard_id, str_customer_ids, **kwargs)

    ##################################

    """ DeviceApiController endpoints """

    def claim_device(self, device_token=None, device_name=None, **kwargs):
    ...
    def delete_user(self, user_id: UserId, **kwargs):
        return self.user_controller.delete_user_using_delete(user_id, **kwargs)

    def get_activation_link(self, user_id: UserId, **kwargs):
        return self.user_controller.get_activation_link_using_get(user_id, **kwargs)

    def get_customer_users(self, customer_id: CustomerId, page_size=100, page=0, **kwargs):
        return self.user_controller.get_customer_users_using_get(customer_id, str(page_size), str(page), **kwargs)

    def get_tenant_admins(self, tenant_id: TenantId, page_size=100, page=0, **kwargs):
        return self.user_controller.get_tenant_admins_using_get(tenant_id, str(page_size), str(page), **kwargs)

    def get_user_by_id(self, user_id: UserId, **kwargs):
        return self.user_controller.get_user_by_id_using_get(user_id, **kwargs)

    def get_user_token(self, user_id: UserId, **kwargs):
        return self.user_controller.get_user_token_using_get(user_id, **kwargs)
    ...
    def set_user_credentials_enabled(self, user_id: UserId, **kwargs):
        return self.user_controller.set_user_credentials_enabled_using_post(user_id, **kwargs)

    ##################################

    """ AuthController endpoints """

    def activate_user(self, activate_request, **kwargs):
        return self.auth_controller.activate_user_using_post(activate_request, **kwargs)
    ...
    """ DeviceProfileController endpoints """

    def delete_device_profile(self, device_profile_id: DeviceProfileId, **kwargs):
        return self.device_profile_controller.delete_device_profile_using_delete(device_profile_id, **kwargs)
    ...
    def get_device_profile_by_id(self, device_profile_id: DeviceProfileId, **kwargs):
        return self.device_profile_controller.get_device_profile_by_id_using_get(device_profile_id, **kwargs)

    def get_device_profile_info_by_id(self, device_profile_id: DeviceProfileId, **kwargs):
        return self.device_profile_controller.get_device_profile_info_by_id_using_get(device_profile_id, **kwargs)
    ...
    def set_default_device_profile(self, device_profile_id: DeviceProfileId, **kwargs):
        return self.device_profile_controller.set_default_device_profile_using_post(device_profile_id, **kwargs)

    ##################################

    """ RuleChainController endpoints """

    def delete_rule_chain(self, rule_chain_id: RuleChainId, **kwargs):
        return self.rule_chain_controller.delete_rule_chain_using_delete(rule_chain_id, **kwargs)
    ...
    def get_latest_rule_node_debug_input(self, rule_node_id: RuleNodeId, **kwargs):
        return self.rule_chain_controller.get_latest_rule_node_debug_input_using_get(rule_node_id, **kwargs)

    def get_rule_chain_by_id(self, rule_chain_id: RuleChainId, **kwargs):
        return self.rule_chain_controller.get_rule_chain_by_id_using_get(rule_chain_id, **kwargs)

    def get_rule_chain_meta_data(self, rule_chain_id: RuleChainId, **kwargs):
        return self.rule_chain_controller.get_rule_chain_meta_data_using_get(rule_chain_id, **kwargs)
    ...
    def save_rule_chain(self, rule_chain=None, request=None, **kwargs):
    ...
    def set_root_rule_chain(self, rule_chain_id: RuleChainId, **kwargs):
        return self.rule_chain_controller.set_root_rule_chain_using_post(rule_chain_id, **kwargs)
    ...
    def ack_alarm(self, alarm_id: AlarmId, **kwargs):
        return self.alarm_controller.ack_alarm_using_post(alarm_id, **kwargs)

    def clear_alarm(self, alarm_id: AlarmId, **kwargs):
        return self.alarm_controller.clear_alarm_using_post(alarm_id, **kwargs)

    def delete_alarm(self, alarm_id: AlarmId, **kwargs):
        return self.alarm_controller.delete_alarm_using_delete(alarm_id, **kwargs)

    def get_alarm_by_id(self, alarm_id: AlarmId, **kwargs):
        return self.alarm_controller.get_alarm_by_id_using_get(alarm_id, **kwargs)

    def get_alarm_info_by_id(self, alarm_id: AlarmId, **kwargs):
        return self.alarm_controller.get_alarm_info_by_id_using_get(alarm_id, **kwargs)

    def get_alarms(self, entity_id: EntityId, page_size=100, page=0, **kwargs):
        return self.alarm_controller.get_alarms_using_get(self.get_type(entity_id), entity_id, str(page_size), str(page), **kwargs)

    def get_highest_alarm_severity(self, entity_id: EntityId, **kwargs):
        return self.alarm_controller.get_highest_alarm_severity_using_get(self.get_type(entity_id), entity_id, **kwargs)
    ...
    """ WidgetTypeController endpoints """

    def delete_widget_type(self, widget_type_id: WidgetTypeId, **kwargs):
        return self.widget_type_controller.delete_widget_type_using_delete(widget_type_id, **kwargs)
    ...
    def get_widget_type_by_id(self, widget_type_id: WidgetTypeId, **kwargs):
        return self.widget_type_controller.get_widget_type_by_id_using_get(widget_type_id, **kwargs)
    ...
    """ TelemetryController endpoints """

    def delete_entity_attributes(self, device_id: DeviceId, scope, keys, entity_id: EntityId = None, **kwargs):
        if device_id is not None:
            return self.telemetry_controller.delete_entity_attributes_using_delete(self.get_id(device_id), scope, keys, **kwargs)
        else:
            return self.telemetry_controller.delete_entity_attributes_using_delete1(self.get_type(entity_id), entity_id, scope, keys, **kwargs)

    def delete_entity_timeseries(self, entity_id: EntityId, keys, **kwargs):
        return self.telemetry_controller.delete_entity_timeseries_using_delete(self.get_type(entity_id), entity_id, keys, **kwargs)

    def get_attribute_keys_by_scope(self, entity_id: EntityId, scope, **kwargs):
        return self.telemetry_controller.get_attribute_keys_by_scope_using_get(self.get_type(entity_id), entity_id, scope, **kwargs)

    def get_attribute_keys(self, entity_id: EntityId, **kwargs):
        return self.telemetry_controller.get_attribute_keys_using_get(self.get_type(entity_id), entity_id, **kwargs)

    def get_attributes_by_scope(self, entity_id: EntityId, scope, **kwargs):
        return self.telemetry_controller.get_attributes_by_scope_using_get(self.get_type(entity_id), entity_id, scope, **kwargs)

    def get_attributes(self, entity_id: EntityId, **kwargs):
        return self.telemetry_controller.get_attributes_using_get(self.get_type(entity_id), entity_id, **kwargs)

    def get_latest_timeseries(self, entity_id: EntityId, **kwargs):
        return self.telemetry_controller.get_latest_timeseries_using_get(self.get_type(entity_id), entity_id, **kwargs)

    def get_timeseries_keys(self, entity_id: EntityId, **kwargs):
        return self.telemetry_controller.get_timeseries_keys_using_get(self.get_type(entity_id), entity_id, **kwargs)

    def get_timeseries(self, entity_id: EntityId, keys, start_ts, end_ts, **kwargs):
        return self.telemetry_controller.get_timeseries_using_get(self.get_type(entity_id), entity_id, keys, start_ts, end_ts, **kwargs)

    def save_device_attributes(self, device_id: DeviceId = None, entity_id: EntityId = None, scope=None, request=None, **kwargs):
        if device_id is not None:
            return self.telemetry_controller.save_device_attributes_using_post(self.get_id(device_id), scope, request, **kwargs)
        else:
            return self.telemetry_controller.save_entity_attributes_v1_using_post(self.get_type(entity_id), entity_id, scope, request, **kwargs)

    def save_entity_telemetry(self, entity_id: EntityId, scope, request_body, **kwargs):
        return self.telemetry_controller.save_entity_telemetry_using_post(self.get_type(entity_id), entity_id, scope, request_body, **kwargs)

    def save_entity_telemetry_with_ttl(self, entity_id: EntityId, scope, ttl, request_body, **kwargs):
        return self.telemetry_controller.save_entity_telemetry_with_ttl_using_post(self.get_type(entity_id), entity_id, scope, ttl, request_body, **kwargs)

    ##################################

    """ RpcController endpoints """

    def handle_one_way_device_rpc_request(self, device_id: DeviceId, request_body, **kwargs):
        return self.rpc_controller.handle_one_way_device_rpc_request_using_post(self.get_id(device_id), request_body, **kwargs)

    def handle_two_way_device_rpc_request(self, device_id: DeviceId, request_body, **kwargs):
        return self.rpc_controller.handle_two_way_device_rpc_request_using_post(self.get_id(device_id), request_body, **kwargs)

    ##################################

    """ WidgetsBundleController endpoints """

    def delete_widgets_bundle(self, widgets_bundle_id: WidgetsBundleId, **kwargs):
        return self.widgets_bundle_controller.delete_widgets_bundle_using_delete(widgets_bundle_id, **kwargs)

    def get_widgets_bundle_by_id(self, widgets_bundle_id: WidgetsBundleId, **kwargs):
        return self.widgets_bundle_controller.get_widgets_bundle_by_id_using_get(widgets_bundle_id, **kwargs)

    def get_widgets_bundles(self, page_size=None, page=None, **kwargs):
    ...
    def delete_tenant(self, tenant_id: TenantId, **kwargs):
        return self.tenant_controller.delete_tenant_using_delete(tenant_id, **kwargs)

    def get_tenant_by_id(self, tenant_id: TenantId, **kwargs):
        return self.tenant_controller.get_tenant_by_id_using_get(tenant_id, **kwargs)

    def get_tenant_info_by_id(self, tenant_id: TenantId, **kwargs):
        return self.tenant_controller.get_tenant_info_by_id_using_get(tenant_id, **kwargs)
    ...
    """ ComponentDescriptorController endpoints """
    ...
    """ TenantProfileController endpoints """

    def delete_tenant_profile(self, tenant_profile_id: TenantProfileId, **kwargs):
        return self.tenant_profile_controller.delete_tenant_profile_using_delete(tenant_profile_id, **kwargs)
    ...
    def get_tenant_profile_by_id(self, tenant_profile_id: TenantProfileId, **kwargs):
        return self.tenant_profile_controller.get_tenant_profile_by_id_using_get(tenant_profile_id, **kwargs)

    def get_tenant_profile_info_by_id(self, tenant_profile_id: TenantProfileId, **kwargs):
        return self.tenant_profile_controller.get_tenant_profile_info_by_id_using_get(tenant_profile_id, **kwargs)
    ...
    def set_default_tenant_profile(self, tenant_profile_id: TenantProfileId, **kwargs):
        return self.tenant_profile_controller.set_default_tenant_profile_using_post(tenant_profile_id, **kwargs)

    ##################################

    """ EntityViewController endpoints """

    def assign_entity_view_to_customer(self, customer_id: CustomerId, entity_view_id: EntityViewId, **kwargs):
        return self.entity_view_controller.assign_entity_view_to_customer_using_post(customer_id, entity_view_id, **kwargs)

    def assign_entity_view_to_public_customer(self, entity_view_id: EntityViewId, **kwargs):
        return self.entity_view_controller.assign_entity_view_to_public_customer_using_post(entity_view_id, **kwargs)

    def delete_entity_view(self, entity_view_id: EntityViewId, **kwargs):
        return self.entity_view_controller.delete_entity_view_using_delete(entity_view_id, **kwargs)

    def get_customer_entity_view_infos(self, customer_id: CustomerId, page_size=100, page=0, **kwargs):
        return self.entity_view_controller.get_customer_entity_view_infos_using_get(customer_id, str(page_size), str(page), **kwargs)

    def get_customer_entity_views(self, customer_id: CustomerId, page_size=100, page=0, **kwargs):
        return self.entity_view_controller.get_customer_entity_views_using_get(customer_id, str(page_size), str(page), **kwargs)

    def get_entity_view_by_id(self, entity_view_id: EntityViewId, **kwargs):
        return self.entity_view_controller.get_entity_view_by_id_using_get(entity_view_id, **kwargs)

    def get_entity_view_info_by_id(self, entity_view_id: EntityViewId, **kwargs):
        return self.entity_view_controller.get_entity_view_info_by_id_using_get(entity_view_id, **kwargs)
    ...
    def unassign_entity_view_from_customer(self, entity_view_id: EntityViewId, **kwargs):
        return self.entity_view_controller.unassign_entity_view_from_customer_using_delete(entity_view_id, **kwargs)

    ##################################

    """ EntityQueryController endpoints """
    ...
    def get_events(self, entity_id: EntityId, event_type=None, tenant_id: TenantId = None, page_size=100, page=0, **kwargs):
        if event_type is not None:
            return self.event_controller.get_events_using_get(self.get_type(entity_id), entity_id, event_type, tenant_id, str(page_size), str(page), **kwargs)
        else:
            return self.event_controller.get_events_using_get1(self.get_type(entity_id), entity_id, tenant_id, str(page_size), str(page), **kwargs)
    ...
    def get_audit_logs_by_customer_id(self, customer_id: CustomerId, page_size=100, page=0, **kwargs):
        return self.audit_log_controller.get_audit_logs_by_customer_id_using_get(customer_id, str(page_size), str(page), **kwargs)

    def get_audit_logs_by_entity_id(self, entity_id: EntityId, page_size=100, page=0, **kwargs):
        return self.audit_log_controller.get_audit_logs_by_entity_id_using_get(self.get_type(entity_id), entity_id, str(page_size), str(page), **kwargs)

    def get_audit_logs_by_user_id(self, user_id: UserId, page_size=100, page=0, **kwargs):
        return self.audit_log_controller.get_audit_logs_by_user_id_using_get(user_id, str(page_size), str(page), **kwargs)
    ...
    """ AssetController endpoints """

    def assign_asset_to_customer(self, customer_id: CustomerId, asset_id: AssetId, **kwargs):
        return self.asset_controller.assign_asset_to_customer_using_post(customer_id, asset_id, **kwargs)

    def assign_asset_to_public_customer(self, asset_id: AssetId, **kwargs):
        return self.asset_controller.assign_asset_to_public_customer_using_post(asset_id, **kwargs)

    def delete_asset(self, asset_id: AssetId, **kwargs):
        return self.asset_controller.delete_asset_using_delete(asset_id, **kwargs)

    def get_asset_by_id(self, asset_id: AssetId, **kwargs):
        return self.asset_controller.get_asset_by_id_using_get(asset_id, **kwargs)

    def get_asset_info_by_id(self, asset_id: AssetId, **kwargs):
        return self.asset_controller.get_asset_info_by_id_using_get(asset_id, **kwargs)
    ...
    def get_customer_asset_infos(self, customer_id: CustomerId, page_size=100, page=0, **kwargs):
        return self.asset_controller.get_customer_asset_infos_using_get(customer_id, str(page_size), str(page), **kwargs)

    def get_customer_assets(self, customer_id: CustomerId, page_size=100, page=0, **kwargs):
        return self.asset_controller.get_customer_assets_using_get(customer_id, str(page_size), str(page), **kwargs)
    ...
    def unassign_asset_from_customer(self, asset_id: AssetId, **kwargs):
        return self.asset_controller.unassign_asset_from_customer_using_delete(asset_id, **kwargs)

    ##################################

    """ OAuth2ConfigTemplateController endpoints """
    ...
    def delete_customer(self, customer_id: CustomerId, **kwargs):
        return self.customer_controller.delete_customer_using_delete(customer_id, **kwargs)

    def get_customer_by_id(self, customer_id: CustomerId, **kwargs):
        return self.customer_controller.get_customer_by_id_using_get(customer_id, **kwargs)

    def get_customer_title_by_id(self, customer_id: CustomerId, **kwargs):
        return self.customer_controller.get_customer_title_by_id_using_get(customer_id, **kwargs)
    ...
    def get_short_customer_info_by_id(self, customer_id: CustomerId, **kwargs):
        return self.customer_controller.get_short_customer_info_by_id_using_get(customer_id, **kwargs)
    ...
    """ EntityRelationController endpoints """
    ...
    def delete_relations(self, entity_id: EntityId, id, type, **kwargs):
        return self.entity_relation_controller.delete_relations_using_delete(entity_id, self.get_type(entity_id), id, type, **kwargs)
    ...
    def save_relation(self, relation: EntityRelation, **kwargs):
        return self.entity_relation_controller.save_relation_using_post(relation, **kwargs)

    def find_info_by_query(self, query: EntityRelationsQuery, **kwargs):
    ...
    def assign_device_to_customer(self, customer_id: CustomerId, device_id: DeviceId, **kwargs):
        return self.device_controller.assign_device_to_customer_using_post(customer_id, self.get_id(device_id), **kwargs)

    def assign_device_to_public_customer(self, device_id: DeviceId, **kwargs):
        return self.device_controller.assign_device_to_public_customer_using_post(self.get_id(device_id), **kwargs)

    def assign_device_to_tenant(self, tenant_id: TenantId, device_id: DeviceId, **kwargs):
        return self.device_controller.assign_device_to_tenant_using_post(tenant_id, self.get_id(device_id), **kwargs)

    def delete_device(self, device_id: DeviceId, **kwargs):
        return self.device_controller.delete_device_using_delete(self.get_id(device_id), **kwargs)

    def get_customer_device_infos(self, customer_id: CustomerId, page_size=100, page=0, **kwargs):
        return self.device_controller.get_customer_device_infos_using_get(customer_id, str(page_size), str(page), **kwargs)

    def get_customer_devices(self, customer_id: CustomerId, page_size=100, page=0, **kwargs):
        return self.device_controller.get_customer_devices_using_get(customer_id, str(page_size), str(page), **kwargs)

    def get_device_by_id(self, device_id: DeviceId, **kwargs):
        return self.device_controller.get_device_by_id_using_get(self.get_id(device_id), **kwargs)

    def get_device_credentials_by_device_id(self, device_id: DeviceId, **kwargs):
        return self.device_controller.get_device_credentials_by_device_id_using_get(self.get_id(device_id), **kwargs)

    def get_device_info_by_id(self, device_id: DeviceId, **kwargs):
        return self.device_controller.get_device_info_by_id_using_get(self.get_id(device_id), **kwargs)
    ...
    def unassign_device_from_customer(self, device_id: DeviceId, **kwargs):
        return self.device_controller.unassign_device_from_customer_using_delete(self.get_id(device_id), **kwargs)
