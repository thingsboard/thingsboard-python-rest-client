...
class OceanConnectIntegrationControllerApi(object):
    ...
    def process_request_using_post4(self, routing_key, msg, request_headers, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.process_request_using_post4(routing_key, msg, request_headers, async_req=True)
        >>> result = thread.get()
    ...
    def process_request_using_post4_with_http_info(self, routing_key, msg, request_headers, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.process_request_using_post4_with_http_info(routing_key, msg, request_headers, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method process_request_using_post4" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'routing_key' is set
