...
class RestClient(Thread):
    ...
    def save_user(self, user: User, send_activation_email, entity_group_id=None):
        return self.user_controller.save_user_using_post(user=user, send_activation_email=send_activation_email, entity_group_id=entity_group_id)
