...
class NotificationRule(object):
    ...
    def __init__(self, id=None, additional_config=None, created_time=None, enabled=None, name=None, recipients_config=None, template_id=None, tenant_id=None, trigger_config=None, trigger_type=None):  # noqa: E501
