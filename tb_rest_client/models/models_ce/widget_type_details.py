...
class WidgetTypeDetails(object):
    ...
    def __init__(self, id=None, created_time=None, tenant_id=None, fqn=None, name=None, deprecated=None, descriptor=None, image=None, description=None, tags=None):  # noqa: E501
