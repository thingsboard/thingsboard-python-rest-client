...
class EdgeEvent(object):
    ...
    def action(self, action):
        ...
        :type: str
        """
        allowed_values = ["ADDED", "ADDED_COMMENT", "ALARM_ACK", "ALARM_ASSIGNED", "ALARM_CLEAR", "ALARM_DELETE", "ALARM_UNASSIGNED", "ASSIGNED_TO_CUSTOMER", "ASSIGNED_TO_EDGE", "ATTRIBUTES_DELETED", "ATTRIBUTES_UPDATED", "CREDENTIALS_REQUEST", "CREDENTIALS_UPDATED", "DELETED", "DELETED_COMMENT", "ENTITY_MERGE_REQUEST", "POST_ATTRIBUTES", "RELATION_ADD_OR_UPDATE", "RELATION_DELETED", "RPC_CALL", "TIMESERIES_UPDATED", "UNASSIGNED_FROM_CUSTOMER", "UNASSIGNED_FROM_EDGE", "UPDATED", "UPDATED_COMMENT"]  # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["ADMIN_SETTINGS", "ALARM", "ALARM_COMMENT", "ASSET", "ASSET_PROFILE", "CUSTOMER", "DASHBOARD", "DEVICE", "DEVICE_PROFILE", "EDGE", "ENTITY_VIEW", "OTA_PACKAGE", "QUEUE", "RELATION", "RULE_CHAIN", "RULE_CHAIN_METADATA", "TB_RESOURCE", "TENANT", "TENANT_PROFILE", "USER", "WIDGETS_BUNDLE", "WIDGET_TYPE"]  # noqa: E501
