...
class AlarmCommentInfo(object):
    ...
    def __init__(self, id=None, created_time=None, alarm_id=None, user_id=None, type=None, comment=None, first_name=None, last_name=None, email=None, name=None):  # noqa: E501
