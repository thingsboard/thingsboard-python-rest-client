...
from tb_rest_client.api_client import ApiClient
    ...
    def __init__(self, id=None, created_time=None, tenant_id=None, name=None, title=None, assigned_customers=None, mobile_hide=None, mobile_order=None, image=None, configuration=None):  # noqa: E501
