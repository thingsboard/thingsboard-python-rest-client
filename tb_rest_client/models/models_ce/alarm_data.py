...
class AlarmData(object):
    ...
    def __init__(self, id=None, created_time=None, tenant_id=None, customer_id=None, type=None, originator=None, severity=None, acknowledged=None, cleared=None, assignee_id=None, start_ts=None, end_ts=None, ack_ts=None, clear_ts=None, assign_ts=None, propagate=None, propagate_to_owner=None, propagate_to_tenant=None, propagate_relation_types=None, originator_name=None, originator_label=None, assignee=None, entity_id=None, latest=None, name=None, status=None, details=None):  # noqa: E501
