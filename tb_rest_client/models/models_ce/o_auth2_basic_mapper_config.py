...
class OAuth2BasicMapperConfig(object):
    ...
    def __init__(self, email_attribute_key=None, first_name_attribute_key=None, last_name_attribute_key=None, tenant_name_strategy=None, tenant_name_pattern=None, customer_name_pattern=None, default_dashboard_name=None, always_full_screen=None):  # noqa: E501
