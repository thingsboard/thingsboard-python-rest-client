...
class TbResource(object):
    ...
    def __init__(self, descriptor=None, link=None, name=None, preview=None, public=None, public_link=None, public_resource_key=None, id=None, created_time=None, tenant_id=None, title=None, resource_type=None, resource_key=None, etag=None, file_name=None, data=None):  # noqa: E501
