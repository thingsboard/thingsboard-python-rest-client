...
class Customer(object):
    ...
    def __init__(self, id=None, created_time=None, title=None, name=None, tenant_id=None, country=None, state=None, city=None, address=None, address2=None, zip=None, phone=None, email=None, additional_info=None):  # noqa: E501
