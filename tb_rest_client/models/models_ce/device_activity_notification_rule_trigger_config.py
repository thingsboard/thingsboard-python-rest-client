...
class DeviceActivityNotificationRuleTriggerConfig(object):
    ...
    def __init__(self, device_profiles=None, devices=None, notify_on=None, trigger_type=None):  # noqa: E501
