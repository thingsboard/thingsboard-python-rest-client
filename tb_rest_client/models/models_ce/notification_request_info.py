...
class NotificationRequestInfo(object):
    ...
    def __init__(self, additional_config=None, created_time=None, delivery_methods=None, id=None, info=None, originator_entity_id=None, rule_id=None, stats=None, status=None, targets=None, template=None, template_id=None, template_name=None, tenant_id=None):  # noqa: E501
    ...
    def delivery_methods(self, delivery_methods):
        ...
        :type: list[str]
        """
        allowed_values = ["EMAIL", "MICROSOFT_TEAMS", "MOBILE_APP", "SLACK", "SMS", "WEB"]  # noqa: E501
