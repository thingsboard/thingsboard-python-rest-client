...
class WidgetsBundleExportData(EntityExportDataobject):
    ...
    def __init__(self, attributes=None, entity=None, entity_type=None, fqns=None, relations=None, widgets=None, *args, **kwargs):  # noqa: E501
