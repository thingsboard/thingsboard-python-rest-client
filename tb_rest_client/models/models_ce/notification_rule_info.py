...
class NotificationRuleInfo(object):
    ...
    def __init__(self, additional_config=None, created_time=None, delivery_methods=None, id=None, enabled=None, name=None, recipients_config=None, template_id=None, template_name=None, tenant_id=None, trigger_config=None, trigger_type=None):  # noqa: E501
