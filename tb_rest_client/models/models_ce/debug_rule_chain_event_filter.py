...
class DebugRuleChainEventFilter(EventFilter):
    ...
    def __init__(self, error=None, event_type=None, msg_direction_type=None, server=None, data_search=None,
                 metadata_search=None, entity_name=None, relation_type=None, entity_id=None, msg_type=None,
                 error_str=None, *args, **kwargs):  # noqa: E501
