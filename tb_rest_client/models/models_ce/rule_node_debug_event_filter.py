...
class RuleNodeDebugEventFilter(EventFilter):
    ...
    def __init__(self, error=None, not_empty=None, event_type=None, server=None, msg_direction_type=None, entity_id=None, entity_type=None, msg_id=None, msg_type=None, relation_type=None, data_search=None, metadata_search=None, error_str=None, *args, **kwargs):  # noqa: E501
