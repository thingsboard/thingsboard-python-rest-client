...
from tb_rest_client.api_client import ApiClient
    ...
    def default_queue_name(self):
        ...
        Reference to the rule engine queue. If present, the specified queue will be used to store all unprocessed messages related to device, including telemetry, attribute updates, etc. Otherwise, the 'Main' queue will be used to store those messages.  # noqa: E501
