...
class DeviceInfo(object):
    ...
    def __init__(self, id=None, created_time=None, tenant_id=None, customer_id=None, name=None, type=None, label=None, device_profile_id=None, device_data=None, firmware_id=None, software_id=None, additional_info=None, customer_title=None, customer_is_public=None, device_profile_name=None, active=None):  # noqa: E501
