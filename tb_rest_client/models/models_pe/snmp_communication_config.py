...
class SnmpCommunicationConfig(object):
    ...
    discriminator_value_class_map = {
        ...
        'ClientAttributesQueryingSnmpCommunicationConfig': 'ClientAttributesQueryingSnmpCommunicationConfig',
        'TelemetryQueryingSnmpCommunicationConfig': 'TelemetryQueryingSnmpCommunicationConfig',
        'ToDeviceRpcRequestSnmpCommunicationConfig': 'ToDeviceRpcRequestSnmpCommunicationConfig'}

    def __init__(self, spec=None):  # noqa: E501
        """SnmpCommunicationConfig - a model defined in Swagger"""  # noqa: E501
        self._spec = None
        self.discriminator = 'spec'
        if spec is not None:
            self.spec = spec
    ...
    def spec(self, spec):
        ...
        :type: str
        """
        allowed_values = ["TELEMETRY_QUERYING", "CLIENT_ATTRIBUTES_QUERYING", "SHARED_ATTRIBUTES_SETTING", "TO_DEVICE_RPC_REQUEST", "TO_SERVER_RPC_REQUEST"]  # noqa: E501
