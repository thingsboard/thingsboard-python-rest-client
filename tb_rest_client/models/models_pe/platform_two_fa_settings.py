...
class PlatformTwoFaSettings(object):
    ...
    def __init__(self, use_system_two_factor_auth_settings=None, providers=None, min_verification_code_send_period=None, verification_code_check_rate_limit=None, max_verification_failures_before_user_lockout=None, total_allowed_time_for_verification=None):  # noqa: E501
