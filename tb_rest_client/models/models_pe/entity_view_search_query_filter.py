...
class EntityViewSearchQueryFilter(EntityFilter):
    ...
    def __init__(self, root_entity=None, relation_type=None, direction=None, max_level=None, fetch_last_level_only=None, entity_view_types=None, *args, **kwargs):  # noqa: E501
