...
class EntityViewSearchQueryFilter(EntityFilter):
    ...
    def __init__(self, direction=None, entity_view_types=None, fetch_last_level_only=None, max_level=None,
                 relation_type=None, root_entity=None, *args, **kwargs):  # noqa: E501
