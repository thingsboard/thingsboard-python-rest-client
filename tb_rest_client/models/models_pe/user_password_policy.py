...
class UserPasswordPolicy(object):
    ...
    def __init__(self, allow_whitespaces=None, force_user_to_reset_password_if_not_valid=None, maximum_length=None, minimum_digits=None, minimum_length=None, minimum_lowercase_letters=None, minimum_special_characters=None, minimum_uppercase_letters=None, password_expiration_period_days=None, password_reuse_frequency_days=None):  # noqa: E501
