...
class TbResource(object):
    ...
    def __init__(self, id=None, created_time=None, tenant_id=None, title=None, resource_type=None, resource_key=None, etag=None, file_name=None, data=None):  # noqa: E501
