...
class VersionLoadConfig(object):
    ...
    def __init__(self, load_relations=None, load_attributes=None, load_credentials=None, load_permissions=None, load_group_entities=None, auto_generate_integration_key=None):  # noqa: E501
