...
class LwM2MServerSecurityConfigDefault(object):
    ...
    def __init__(self, short_server_id=None, bootstrap_server_is=None, host=None, port=None, client_hold_off_time=None, server_public_key=None, server_certificate=None, bootstrap_server_account_timeout=None, lifetime=None, default_min_period=None, notif_if_disabled=None, binding=None, security_host=None, security_port=None):  # noqa: E501
