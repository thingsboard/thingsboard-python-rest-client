...
class DeviceSearchQueryFilter(EntityFilter):
    ...
    def __init__(self, root_entity=None, relation_type=None, direction=None, max_level=None, fetch_last_level_only=None, device_types=None, *args, **kwargs):  # noqa: E501
