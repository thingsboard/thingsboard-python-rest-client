...
class SchedulerEventInfo(object):
    ...
    def __init__(self, id=None, created_time=None, tenant_id=None, customer_id=None, originator_id=None, owner_id=None, name=None, type=None, schedule=None, enabled=None, additional_info=None):  # noqa: E501
