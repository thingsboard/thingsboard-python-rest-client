...
class RuleNode(object):
    ...
    def __init__(self, external_id=None, id=None, created_time=None, rule_chain_id=None, type=None, name=None, debug_mode=None, singleton_mode=None, configuration_version=None, configuration=None, additional_info=None):  # noqa: E501
