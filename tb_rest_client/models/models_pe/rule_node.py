...
class RuleNode(object):
    ...
    def __init__(self, external_id=None, id=None, created_time=None, rule_chain_id=None, type=None, name=None, debug_mode=None, singleton_mode=None, queue_name=None, configuration_version=None, additional_info=None, configuration=None):  # noqa: E501
