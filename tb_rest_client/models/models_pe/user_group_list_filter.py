...
class UserGroupListFilter(UsersFilter):
    ...
    def __init__(self, groups_ids=None, *args, **kwargs):  # noqa: E501
        """UserGroupListFilter - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def groups_ids(self):
        """Gets the groups_ids of this UserGroupListFilter.  # noqa: E501


        :return: The groups_ids of this UserGroupListFilter.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def groups_ids(self, groups_ids):
        """Sets the groups_ids of this UserGroupListFilter.


        :param groups_ids: The groups_ids of this UserGroupListFilter.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserGroupListFilter, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserGroupListFilter):
            return False
