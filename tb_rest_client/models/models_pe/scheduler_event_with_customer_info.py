...
class SchedulerEventWithCustomerInfo(object):
    ...
    def __init__(self, id=None, created_time=None, tenant_id=None, customer_id=None, originator_id=None, owner_id=None, name=None, type=None, schedule=None, additional_info=None, customer_title=None, customer_is_public=None):  # noqa: E501
