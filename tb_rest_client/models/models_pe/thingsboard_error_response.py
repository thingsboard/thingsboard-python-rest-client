...
from tb_rest_client.api_client import ApiClient
    ...
    def __init__(self, status=None, message=None, error_code=None, timestamp=None, subscription_entry=None, subscription_error_code=None, subscription_value=None):  # noqa: E501
