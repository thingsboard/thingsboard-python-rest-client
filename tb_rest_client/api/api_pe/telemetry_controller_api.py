...
class TelemetryControllerApi(object):
    ...
    def get_timeseries_by_read_ts_kv_queries(self, body, entity_type, entity_id, **kwargs):  # noqa: E501
        """Get time series data by read queries (getTimeseriesByReadTsKvQueries)  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_timeseries_by_read_ts_kv_queries(body, entity_type, entity_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_timeseries_by_read_ts_kv_queries_with_http_info(body, entity_type, entity_id,
                                                                            **kwargs)  # noqa: E501
        else:
            (data) = self.get_timeseries_by_read_ts_kv_queries_with_http_info(body, entity_type, entity_id,
                                                                              **kwargs)  # noqa: E501
            return data

    def get_timeseries_by_read_ts_kv_queries_with_http_info(self, body, entity_type, entity_id, **kwargs):  # noqa: E501
        """Get time series data by read queries (getTimeseriesByReadTsKvQueries)  # noqa: E501

        Returns aggregated time series values according to queries for specified entity. ```json [   {     \"queryId\": 49,     \"data\": [       {         \"ts\": 1751450399999,         \"kv\": {           \"key\": \"temperature\",           \"value\": 26,           \"doubleValue\": 26,           \"valueAsString\": \"26.0\",           \"dataType\": \"DOUBLE\",           \"longValue\": null,           \"booleanValue\": null,           \"jsonValue\": null,           \"strValue\": null         },         \"version\": null       }     ],     \"lastEntryTs\": 1750264592675   },   {     \"queryId\": 50,     \"data\": [],     \"lastEntryTs\": 1751317200000   } ] ```  Referencing a non-existing entity Id or invalid entity type will cause an error.   Available for users with 'TENANT_ADMIN' or 'CUSTOMER_USER' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_timeseries_by_read_ts_kv_queries_with_http_info(body, entity_type, entity_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_timeseries_by_read_ts_kv_queries" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError(
                "Missing the required parameter `body` when calling `get_timeseries_by_read_ts_kv_queries`")  # noqa: E501
        # verify the required parameter 'entity_type' is set
        if ('entity_type' not in params or
                params['entity_type'] is None):
            raise ValueError(
                "Missing the required parameter `entity_type` when calling `get_timeseries_by_read_ts_kv_queries`")  # noqa: E501
        # verify the required parameter 'entity_id' is set
        if ('entity_id' not in params or
                params['entity_id'] is None):
            raise ValueError(
                "Missing the required parameter `entity_id` when calling `get_timeseries_by_read_ts_kv_queries`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/plugins/telemetry/{entityType}/{entityId}/values/timeseries', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
