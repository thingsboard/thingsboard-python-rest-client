...
class NotificationControllerApi(object):
    ...
    def send_addon_access_error(self, addon_type, **kwargs):  # noqa: E501
        """Send add-on access error notification to System/Tenant administrators (sendAddonAccessError)  # noqa: E501

        Send add-on access error notification by Tenant Administrator or Customer User to System/Tenant administrators.  Available for users with 'TENANT_ADMIN' or 'CUSTOMER_USER' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.send_addon_access_error(addon_type, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str addon_type: Addon type (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.send_addon_access_error_with_http_info(addon_type, **kwargs)  # noqa: E501
        else:
            (data) = self.send_addon_access_error_with_http_info(addon_type, **kwargs)  # noqa: E501
            return data

    def send_addon_access_error_with_http_info(self, addon_type, **kwargs):  # noqa: E501
        """Send add-on access error notification to System/Tenant administrators (sendAddonAccessError)  # noqa: E501

        Send add-on access error notification by Tenant Administrator or Customer User to System/Tenant administrators.  Available for users with 'TENANT_ADMIN' or 'CUSTOMER_USER' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.send_addon_access_error_with_http_info(addon_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['addon_type']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method send_addon_access_error" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('addon_type' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `addon_type` when calling `send_addon_access_error`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'addon_type' in params:
            path_params['addonType'] = params['addon_type']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/notification/sendAddonAccessError/{addonType}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def send_entities_limit_increase_request(self, entity_type, **kwargs):  # noqa: E501
        """Send entity limit increase request notification to System/Tenant administrators (sendEntitiesLimitIncreaseRequest)  # noqa: E501

        Send entity limit increase request notification by Tenant Administrator or Customer User to System/Tenant administrators.  Available for users with 'TENANT_ADMIN' or 'CUSTOMER_USER' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.send_entities_limit_increase_request(entity_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.send_entities_limit_increase_request_with_http_info(entity_type, **kwargs)  # noqa: E501
        else:
            (data) = self.send_entities_limit_increase_request_with_http_info(entity_type, **kwargs)  # noqa: E501
            return data

    def send_entities_limit_increase_request_with_http_info(self, entity_type, **kwargs):  # noqa: E501
        """Send entity limit increase request notification to System/Tenant administrators (sendEntitiesLimitIncreaseRequest)  # noqa: E501

        Send entity limit increase request notification by Tenant Administrator or Customer User to System/Tenant administrators.  Available for users with 'TENANT_ADMIN' or 'CUSTOMER_USER' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.send_entities_limit_increase_request_with_http_info(entity_type, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method send_entities_limit_increase_request" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('entity_type' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `entity_type` when calling `send_entities_limit_increase_request`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/notification/entitiesLimitIncreaseRequest/{entityType}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
