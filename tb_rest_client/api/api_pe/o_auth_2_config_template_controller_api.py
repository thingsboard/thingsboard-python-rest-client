...
class OAuth2ConfigTemplateControllerApi(object):
    ...
    def get_client_registration_templates_using_get1(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_client_registration_templates_using_get1(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_client_registration_templates_using_get1_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_client_registration_templates_using_get1_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_client_registration_templates_using_get1_with_http_info(self, **kwargs):  # noqa: E501
        """Get the list of all OAuth2 client registration templates (getClientRegistrationTemplates)  Available for users with 'SYS_ADMIN' or 'TENANT_ADMIN' authority.  # noqa: E501

        Client registration template is OAuth2 provider configuration template with default settings for registering new OAuth2 clients  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_client_registration_templates_using_get1_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_client_registration_templates_using_get1" % key
                )
            params[key] = val
        del params['kwargs']
