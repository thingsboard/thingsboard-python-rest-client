...
class EntityViewControllerApi(object):
    ...
    def get_entity_views_by_ids(self, entity_view_ids, **kwargs):  # noqa: E501
        """Get Entity Views By Ids (getEntityViewsByIds)  # noqa: E501

        Requested entity views must be owned by tenant or assigned to customer which user is performing the request.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_entity_views_by_ids(entity_view_ids, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_entity_views_by_ids_with_http_info(entity_view_ids, **kwargs)  # noqa: E501
        else:
            (data) = self.get_entity_views_by_ids_with_http_info(entity_view_ids, **kwargs)  # noqa: E501
            return data

    def get_entity_views_by_ids_with_http_info(self, entity_view_ids, **kwargs):  # noqa: E501
        """Get Entity Views By Ids (getEntityViewsByIds)  # noqa: E501

        Requested entity views must be owned by tenant or assigned to customer which user is performing the request.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_entity_views_by_ids_with_http_info(entity_view_ids, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_entity_views_by_ids" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'entity_view_ids' is set
        if ('entity_view_ids' not in params or
                params['entity_view_ids'] is None):
            raise ValueError(
                "Missing the required parameter `entity_view_ids` when calling `get_entity_views_by_ids`")  # noqa: E501
