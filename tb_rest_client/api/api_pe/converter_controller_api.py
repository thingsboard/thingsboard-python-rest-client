...
class ConverterControllerApi(object):
    ...
    def unwrap_raw_payload(self, body, integration_type, **kwargs):  # noqa: E501
        """Transform input raw payload to the dedicated converter data (unwrapRawPayload)  # noqa: E501

        Returns a JSON object representing the result of the unwrapped incoming raw message.   ## Request Body Example  ```json {    \"metadata\":{    },    \"payload\":\"ewogICAgImRhdGEiOiAiZGF0YSIKfQ==\", } ``` * 'metadata' - integration metadata;   * 'payload' - JSON object representing the input raw message.  ## Response Body Example   * 'metadata' - integration metadata enriched with the data from the input message;   * 'payload' - base64 string representation of the payload from the unwrapped input message;   * 'contentType' - string representation payload contentType.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unwrap_raw_payload(body, integration_type, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param object body: A JSON value representing the input message. (required)
        :param object integration_type: A string value representing the integration type. One of the following: APACHE_PULSAR, AWS_IOT, AWS_KINESIS, AWS_SQS, AZURE_EVENT_HUB, AZURE_IOT_HUB, AZURE_SERVICE_BUS, CHIRPSTACK, COAP, CUSTOM, HTTP, IBM_WATSON_IOT, KAFKA, LORIOT, MQTT, OCEANCONNECT, OPC_UA, PUB_SUB, RABBITMQ,  SIGFOX,  TCP,  THINGPARK,  TMOBILE_IOT_CDP,  TPE,  TTI,  TTN,  TUYA,  UDP (required)
        :return: JsonNode
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.unwrap_raw_payload_with_http_info(body, integration_type, **kwargs)  # noqa: E501
        else:
            (data) = self.unwrap_raw_payload_with_http_info(body, integration_type, **kwargs)  # noqa: E501
            return data

    def unwrap_raw_payload_with_http_info(self, body, integration_type, **kwargs):  # noqa: E501
        """Transform input raw payload to the dedicated converter data (unwrapRawPayload)  # noqa: E501

        Returns a JSON object representing the result of the unwrapped incoming raw message.   ## Request Body Example  ```json {    \"metadata\":{    },    \"payload\":\"ewogICAgImRhdGEiOiAiZGF0YSIKfQ==\", } ``` * 'metadata' - integration metadata;   * 'payload' - JSON object representing the input raw message.  ## Response Body Example   * 'metadata' - integration metadata enriched with the data from the input message;   * 'payload' - base64 string representation of the payload from the unwrapped input message;   * 'contentType' - string representation payload contentType.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unwrap_raw_payload_with_http_info(body, integration_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'integration_type']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method unwrap_raw_payload" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `unwrap_raw_payload`")  # noqa: E501
        # verify the required parameter 'integration_type' is set
        if ('integration_type' not in params or
                params['integration_type'] is None):
            raise ValueError(
                "Missing the required parameter `integration_type` when calling `unwrap_raw_payload`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/converter/unwrap/{integrationType}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
