...
class SchedulerEventControllerApi(object):
    ...
    def get_all_edge_scheduler_events(self, edge_id, **kwargs):  # noqa: E501
        """Get All Edge Scheduler Events (getAllEdgeSchedulerEvents)  # noqa: E501

        Fetch the list of Scheduler Event Info objects based on the provided Edge entity. Scheduler Event extends Scheduler Event Info object and adds 'configuration' - a JSON structure of scheduler event configuration. See the 'Model' tab of the Response Class for more details. Scheduler Events allows you to schedule various types of events with flexible schedule configuration. Scheduler fires configured scheduler events according to their schedule. See the 'Model' tab of the Response Class for more details.   Available for users with 'TENANT_ADMIN' or 'CUSTOMER_USER' authority. Security check is performed to verify that the user has 'READ' permission for the entity (entities).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_edge_scheduler_events(edge_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_edge_scheduler_events_with_http_info(edge_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_all_edge_scheduler_events_with_http_info(edge_id, **kwargs)  # noqa: E501
            return data

    def get_all_edge_scheduler_events_with_http_info(self, edge_id, **kwargs):  # noqa: E501
        """Get All Edge Scheduler Events (getAllEdgeSchedulerEvents)  # noqa: E501

        Fetch the list of Scheduler Event Info objects based on the provided Edge entity. Scheduler Event extends Scheduler Event Info object and adds 'configuration' - a JSON structure of scheduler event configuration. See the 'Model' tab of the Response Class for more details. Scheduler Events allows you to schedule various types of events with flexible schedule configuration. Scheduler fires configured scheduler events according to their schedule. See the 'Model' tab of the Response Class for more details.   Available for users with 'TENANT_ADMIN' or 'CUSTOMER_USER' authority. Security check is performed to verify that the user has 'READ' permission for the entity (entities).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_edge_scheduler_events_with_http_info(edge_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_edge_scheduler_events" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'edge_id' is set
        if ('edge_id' not in params or
                params['edge_id'] is None):
            raise ValueError(
                "Missing the required parameter `edge_id` when calling `get_all_edge_scheduler_events`")  # noqa: E501
    ...
    def get_scheduled_report_events(self, page_size, page, **kwargs):  # noqa: E501
        """Get Scheduled Report Events (getScheduledReportEvents)  # noqa: E501

          Available for users with 'TENANT_ADMIN' authority.   Security check is performed to verify that the user has 'READ' permission for the entity (entities).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_scheduled_report_events(page_size, page, async_req=True)
        >>> result = thread.get()
        ...
        :param str text_search: The case insensitive 'substring' filter based on the scheduler event name or customer title.
        :param str sort_property: Property of entity to sort by
        :param str sort_order: Sort order. ASC (ASCENDING) or DESC (DESCENDING)
        :return: PageDataScheduledReportInfo
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_scheduled_report_events_with_http_info(page_size, page, **kwargs)  # noqa: E501
        else:
            (data) = self.get_scheduled_report_events_with_http_info(page_size, page, **kwargs)  # noqa: E501
            return data

    def get_scheduled_report_events_with_http_info(self, page_size, page, **kwargs):  # noqa: E501
        """Get Scheduled Report Events (getScheduledReportEvents)  # noqa: E501

          Available for users with 'TENANT_ADMIN' authority.   Security check is performed to verify that the user has 'READ' permission for the entity (entities).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_scheduled_report_events_with_http_info(page_size, page, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_scheduled_report_events" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'page_size' is set
        if ('page_size' not in params or
                params['page_size'] is None):
            raise ValueError(
                "Missing the required parameter `page_size` when calling `get_scheduled_report_events`")  # noqa: E501
        # verify the required parameter 'page' is set
        if ('page' not in params or
                params['page'] is None):
            raise ValueError(
                "Missing the required parameter `page` when calling `get_scheduled_report_events`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/scheduledReports{?reportTemplateId,userId,includeCustomers,pageSize,page,textSearch,sortProperty,sortOrder}',
            'GET',
            path_params,
            query_params,
            header_params,
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PageDataScheduledReportInfo',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
