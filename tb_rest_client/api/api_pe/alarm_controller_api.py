...
class AlarmControllerApi(object):
    ...
    def get_alarms_using_get_with_http_info(self, entity_type, entity_id, page_size, page, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/alarm/{entityType}/{entityId}{?endTime,fetchOriginator,page,pageSize,searchStatus,sortOrder,sortProperty,startTime,status,textSearch}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_all_alarms_using_get_with_http_info(self, page_size, page, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/alarms{?endTime,fetchOriginator,page,pageSize,searchStatus,sortOrder,sortProperty,startTime,status,textSearch}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
