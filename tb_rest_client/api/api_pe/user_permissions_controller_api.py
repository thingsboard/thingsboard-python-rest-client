...
class UserPermissionsControllerApi(object):
    ...
    def has_entity_permission(self, entity_type, entity_id, operation, **kwargs):  # noqa: E501
        """Check permission for specified entity (hasEntityPermission)  # noqa: E501

        Returns true if the user has permission to perform the operation, and false otherwise.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.has_entity_permission(entity_type, entity_id, operation, async_req=True)
        >>> result = thread.get()
        ...
        :param str operation: A string value representing permission operation. For example, 'READ', 'WRITE', 'DELETE', 'CREATE', 'ALL' (required)
        :return: bool
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.has_entity_permission_with_http_info(entity_type, entity_id, operation, **kwargs)  # noqa: E501
        else:
            (data) = self.has_entity_permission_with_http_info(entity_type, entity_id, operation,
                                                               **kwargs)  # noqa: E501
            return data

    def has_entity_permission_with_http_info(self, entity_type, entity_id, operation, **kwargs):  # noqa: E501
        """Check permission for specified entity (hasEntityPermission)  # noqa: E501

        Returns true if the user has permission to perform the operation, and false otherwise.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.has_entity_permission_with_http_info(entity_type, entity_id, operation, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['entity_type', 'entity_id', 'operation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method has_entity_permission" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('entity_type' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `entity_type` when calling `has_entity_permission`")  # noqa: E501
        # verify the required parameter 'entity_id' is set
        if ('entity_id' not in params or
                params['entity_id'] is None):
            raise ValueError(
                "Missing the required parameter `entity_id` when calling `has_entity_permission`")  # noqa: E501
        # verify the required parameter 'operation' is set
        if ('operation' not in params or
                params['operation'] is None):
            raise ValueError(
                "Missing the required parameter `operation` when calling `has_entity_permission`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/permission/{entityType}/{entityId}/{operation}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
