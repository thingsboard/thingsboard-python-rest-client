...
class EntityQueryControllerApi(object):
    ...
    def is_edqs_api_enabled(self, **kwargs):  # noqa: E501
        """isEdqsApiEnabled  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.is_edqs_api_enabled(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.is_edqs_api_enabled_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.is_edqs_api_enabled_with_http_info(**kwargs)  # noqa: E501
            return data

    def is_edqs_api_enabled_with_http_info(self, **kwargs):  # noqa: E501
        """isEdqsApiEnabled  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.is_edqs_api_enabled_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method is_edqs_api_enabled" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def process_system_edqs_request(self, body, **kwargs):  # noqa: E501
        """processSystemEdqsRequest  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.process_system_edqs_request(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.process_system_edqs_request_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.process_system_edqs_request_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def process_system_edqs_request_with_http_info(self, body, **kwargs):  # noqa: E501
        """processSystemEdqsRequest  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.process_system_edqs_request_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method process_system_edqs_request" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError(
                "Missing the required parameter `body` when calling `process_system_edqs_request`")  # noqa: E501
    ...
    def get_edqs_state(self, **kwargs):  # noqa: E501
        """getEdqsState  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_edqs_state(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_edqs_state_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_edqs_state_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_edqs_state_with_http_info(self, **kwargs):  # noqa: E501
        """getEdqsState  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_edqs_state_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='EdqsState',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def find_available_entity_keys_by_query(self, body, timeseries, attributes, **kwargs):  # noqa: E501
        """Find Available Entity Keys by Query  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.find_available_entity_keys_by_query(body, timeseries, attributes, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param EntityDataQuery body: (required)
        :param bool timeseries: When true, includes unique time series key names in the response. When false, the 'timeseries' list will be empty. (required)
        :param bool attributes: When true, includes unique attribute key names in the response. When false, the 'attribute' list will be empty. Use 'scope' parameter to filter by attribute scope. (required)
        :param str scope: Filters attribute keys by scope. Only applies when 'attributes' is true. If not specified, returns attribute keys from all scopes.
        :return: AvailableEntityKeys
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.find_available_entity_keys_by_query_with_http_info(body, timeseries, attributes,
                                                                           **kwargs)  # noqa: E501
        else:
            (data) = self.find_available_entity_keys_by_query_with_http_info(body, timeseries, attributes,
                                                                             **kwargs)  # noqa: E501
            return data

    def find_available_entity_keys_by_query_with_http_info(self, body, timeseries, attributes, **kwargs):  # noqa: E501
        """Find Available Entity Keys by Query  # noqa: E501

        Returns unique time series and/or attribute key names from entities matching the query.  Executes the Entity Data Query to find up to 100 entities, then fetches and aggregates all distinct key names.  Primarily used for UI features like autocomplete suggestions.  Available for users with 'TENANT_ADMIN' or 'CUSTOMER_USER' authority. Security check is performed to verify that the user has 'READ' permission for the entity (entities).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.find_available_entity_keys_by_query_with_http_info(body, timeseries, attributes, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'timeseries', 'attributes', 'scope']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method find_available_entity_keys_by_query" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError(
                "Missing the required parameter `body` when calling `find_available_entity_keys_by_query`")  # noqa: E501
        # verify the required parameter 'timeseries' is set
        if ('timeseries' not in params or
                params['timeseries'] is None):
            raise ValueError(
                "Missing the required parameter `timeseries` when calling `find_available_entity_keys_by_query`")  # noqa: E501
        # verify the required parameter 'attributes' is set
        if ('attributes' not in params or
                params['attributes'] is None):
            raise ValueError(
                "Missing the required parameter `attributes` when calling `find_available_entity_keys_by_query`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/entitiesQuery/find/keys{?timeseries,attributes,scope}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='AvailableEntityKeys',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
