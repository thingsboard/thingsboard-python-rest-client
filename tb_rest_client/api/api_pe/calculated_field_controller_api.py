...
class CalculatedFieldControllerApi(object):
    ...
    def get_calculated_field_names(self, type, page_size, page, **kwargs):  # noqa: E501
        """Get calculated field names (getCalculatedFieldNames)  # noqa: E501

        Fetch the list of calculated field names for specified type.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_calculated_field_names(type, page_size, page, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str type: Calculated field type filter. (required)
        :param int page_size: Maximum amount of entities in a one page (required)
        :param int page: Sequence number of page starting from 0 (required)
        :param str text_search: The case insensitive 'substring' filter based on the calculated field name.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_calculated_field_names_with_http_info(type, page_size, page, **kwargs)  # noqa: E501
        else:
            (data) = self.get_calculated_field_names_with_http_info(type, page_size, page, **kwargs)  # noqa: E501
            return data

    def get_calculated_field_names_with_http_info(self, type, page_size, page, **kwargs):  # noqa: E501
        """Get calculated field names (getCalculatedFieldNames)  # noqa: E501

        Fetch the list of calculated field names for specified type.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_calculated_field_names_with_http_info(type, page_size, page, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['type', 'page_size', 'page', 'text_search', 'sort_order']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_calculated_field_names" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('type' not in params or
                params['type'] is None):
            raise ValueError(
                "Missing the required parameter `type` when calling `get_calculated_field_names`")  # noqa: E501
        # verify the required parameter 'page_size' is set
        if ('page_size' not in params or
                params['page_size'] is None):
            raise ValueError(
                "Missing the required parameter `page_size` when calling `get_calculated_field_names`")  # noqa: E501
        # verify the required parameter 'page' is set
        if ('page' not in params or
                params['page'] is None):
            raise ValueError(
                "Missing the required parameter `page` when calling `get_calculated_field_names`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/calculatedFields/names{?type,pageSize,page,textSearch,sortOrder}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PageDataString',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
