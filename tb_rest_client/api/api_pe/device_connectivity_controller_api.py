...
class DeviceConnectivityControllerApi(object):
    ...
    def get_gateway_launch_commands_using_get(self, device_id, **kwargs):  # noqa: E501
        """Get commands to launch gateway (getGatewayLaunchCommands)  # noqa: E501

        Fetch the list of commands for different operation systems to launch a gateway using docker.  Available for users with 'TENANT_ADMIN' or 'CUSTOMER_USER' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_gateway_launch_commands_using_get(device_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_gateway_launch_commands_using_get_with_http_info(device_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_gateway_launch_commands_using_get_with_http_info(device_id, **kwargs)  # noqa: E501
            return data

    def get_gateway_launch_commands_using_get_with_http_info(self, device_id, **kwargs):  # noqa: E501
        """Get commands to launch gateway (getGatewayLaunchCommands)  # noqa: E501

        Fetch the list of commands for different operation systems to launch a gateway using docker.  Available for users with 'TENANT_ADMIN' or 'CUSTOMER_USER' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_gateway_launch_commands_using_get_with_http_info(device_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_gateway_launch_commands_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'device_id' is set
        if ('device_id' not in params or
                params['device_id'] is None):
            raise ValueError("Missing the required parameter `device_id` when calling `get_gateway_launch_commands_using_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/device-connectivity/gateway-launch/{deviceId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
