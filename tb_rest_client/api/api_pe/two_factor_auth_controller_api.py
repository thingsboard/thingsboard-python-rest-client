...
class TwoFactorAuthControllerApi(object):
    ...
    def authenticate_by_two_fa_configuration_token(self, **kwargs):  # noqa: E501
        """Get regular token pair after successfully configuring 2FA  # noqa: E501

        Checks 2FA is configured, returning token pair on success.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.authenticate_by_two_fa_configuration_token(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.authenticate_by_two_fa_configuration_token_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.authenticate_by_two_fa_configuration_token_with_http_info(**kwargs)  # noqa: E501
            return data

    def authenticate_by_two_fa_configuration_token_with_http_info(self, **kwargs):  # noqa: E501
        """Get regular token pair after successfully configuring 2FA  # noqa: E501

        Checks 2FA is configured, returning token pair on success.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.authenticate_by_two_fa_configuration_token_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method authenticate_by_two_fa_configuration_token" % key
                )
            params[key] = val
        del params['kwargs']
