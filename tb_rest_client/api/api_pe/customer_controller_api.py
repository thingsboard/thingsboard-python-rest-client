...
class CustomerControllerApi(object):
    ...
    def get_customers_by_ids(self, customer_ids, **kwargs):  # noqa: E501
        """Get customers by Customer Ids (getCustomersByIds)  # noqa: E501

        Returns a list of Customer objects based on the provided ids.  Available for users with 'TENANT_ADMIN' or 'CUSTOMER_USER' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customers_by_ids(customer_ids, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_customers_by_ids_with_http_info(customer_ids, **kwargs)  # noqa: E501
        else:
            (data) = self.get_customers_by_ids_with_http_info(customer_ids, **kwargs)  # noqa: E501
            return data

    def get_customers_by_ids_with_http_info(self, customer_ids, **kwargs):  # noqa: E501
        """Get customers by Customer Ids (getCustomersByIds)  # noqa: E501

        Returns a list of Customer objects based on the provided ids.  Available for users with 'TENANT_ADMIN' or 'CUSTOMER_USER' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customers_by_ids_with_http_info(customer_ids, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_customers_by_ids" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'customer_ids' is set
        if ('customer_ids' not in params or
                params['customer_ids'] is None):
            raise ValueError(
                "Missing the required parameter `customer_ids` when calling `get_customers_by_ids`")  # noqa: E501
