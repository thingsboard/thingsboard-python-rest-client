...
class WhiteLabelingControllerApi(object):
    ...
    def delete_current_login_white_label_params(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_current_login_white_label_params(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_current_login_white_label_params_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.delete_current_login_white_label_params_with_http_info(**kwargs)  # noqa: E501
            return data

    def delete_current_login_white_label_params_with_http_info(self, **kwargs):  # noqa: E501
        """Delete Login White Labeling configuration (deleteCurrentLoginWhiteLabelParams)  # noqa: E501

        Delete the Login White Labeling configuration that corresponds to the authority of the user.   Security check is performed to verify that the user has 'WRITE' permission for the white labeling resource.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_current_login_white_label_params_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_current_login_white_label_params" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/whiteLabel/currentLoginWhiteLabelParams{?customerId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_current_white_label_params(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_current_white_label_params(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_current_white_label_params_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.delete_current_white_label_params_with_http_info(**kwargs)  # noqa: E501
            return data

    def delete_current_white_label_params_with_http_info(self, **kwargs):  # noqa: E501
        """Delete General White Labeling configuration (deleteCurrentWhiteLabelParams)  # noqa: E501

        Delete the White Labeling configuration that corresponds to the authority of the user.   Security check is performed to verify that the user has 'WRITE' permission for the white labeling resource.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_current_white_label_params_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_current_white_label_params" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/whiteLabel/currentWhiteLabelParams{?customerId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
