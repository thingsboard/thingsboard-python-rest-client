...
class Lwm2mControllerApi(object):
    ...
    def save_device_with_credentials(self, body, **kwargs):  # noqa: E501
        """Save device with credentials (Deprecated)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_device_with_credentials(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.save_device_with_credentials_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.save_device_with_credentials_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def save_device_with_credentials_with_http_info(self, body, **kwargs):  # noqa: E501
        """Save device with credentials (Deprecated)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_device_with_credentials_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method save_device_with_credentials" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError(
                "Missing the required parameter `body` when calling `save_device_with_credentials`")  # noqa: E501
