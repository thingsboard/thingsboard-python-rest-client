...
class TenantControllerApi(object):
    ...
    def get_tenants_by_ids(self, tenant_ids, **kwargs):  # noqa: E501
        """getTenantsByIds  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_tenants_by_ids(tenant_ids, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str tenant_ids: A list of tenant ids, separated by comma ',' (required)
        :return: list
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_tenants_by_ids_with_http_info(tenant_ids, **kwargs)  # noqa: E501
        else:
            (data) = self.get_tenants_by_ids_with_http_info(tenant_ids, **kwargs)  # noqa: E501
            return data

    def get_tenants_by_ids_with_http_info(self, tenant_ids, **kwargs):  # noqa: E501
        """getTenantsByIds  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_tenants_by_ids_with_http_info(tenant_ids, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_tenants_by_ids" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('tenant_ids' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `tenant_ids` when calling `get_tenants_by_ids`")  # noqa: E501
