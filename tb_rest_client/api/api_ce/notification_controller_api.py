...
class NotificationControllerApi(object):
    ...
    def send_entities_limit_increase_request(self, entity_type, **kwargs):  # noqa: E501
        """Send entity limit increase request notification to System administrators (sendEntitiesLimitIncreaseRequest)  # noqa: E501

        Send entity limit increase request notification by Tenant Administrator to System administrators.  Available for users with 'TENANT_ADMIN' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
