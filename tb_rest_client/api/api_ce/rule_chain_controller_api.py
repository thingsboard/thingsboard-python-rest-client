...
class RuleChainControllerApi(object):
    ...
    def get_rule_chains_by_ids(self, rule_chain_ids, **kwargs):  # noqa: E501
        """Get Rule Chains By Ids (getRuleChainsByIds)  # noqa: E501

        Requested rule chains must be owned by tenant which is performing the request.     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_rule_chains_by_ids(rule_chain_ids, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_rule_chains_by_ids_with_http_info(rule_chain_ids, **kwargs)  # noqa: E501
        else:
            (data) = self.get_rule_chains_by_ids_with_http_info(rule_chain_ids, **kwargs)  # noqa: E501
            return data

    def get_rule_chains_by_ids_with_http_info(self, rule_chain_ids, **kwargs):  # noqa: E501
        """Get Rule Chains By Ids (getRuleChainsByIds)  # noqa: E501

        Requested rule chains must be owned by tenant which is performing the request.     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_rule_chains_by_ids_with_http_info(rule_chain_ids, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['rule_chain_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_rule_chains_by_ids" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'rule_chain_ids' is set
        if ('rule_chain_ids' not in params or
                params['rule_chain_ids'] is None):
            raise ValueError(
                "Missing the required parameter `rule_chain_ids` when calling `get_rule_chains_by_ids`")  # noqa: E501
        ...
        query_params = []
        if 'rule_chain_ids' in params:
            query_params.append(('ruleChainIds', params['rule_chain_ids']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/ruleChains{?ruleChainIds}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
