...
class EdgeControllerApi(object):
    ...
    def get_edge_docker_install_instructions_using_get(self, edge_id, method, **kwargs):  # noqa: E501
        """Get Edge Docker Install Instructions (getEdgeDockerInstallInstructions)  # noqa: E501

        Get a docker install instructions for provided edge id.  Available for users with 'TENANT_ADMIN' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_edge_docker_install_instructions_using_get(edge_id, method, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str edge_id: A string value representing the edge id. For example, '784f394c-42b6-435a-983c-b7beff2784f9' (required)
        :param str method: Installation method ('docker', 'ubuntu' or 'centos') (required)
        :return: EdgeInstallInstructions
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_edge_docker_install_instructions_using_get_with_http_info(edge_id, method, **kwargs)  # noqa: E501
        else:
            (data) = self.get_edge_docker_install_instructions_using_get_with_http_info(edge_id, method, **kwargs)  # noqa: E501
            return data

    def get_edge_docker_install_instructions_using_get_with_http_info(self, edge_id, method, **kwargs):  # noqa: E501
        """Get Edge Docker Install Instructions (getEdgeDockerInstallInstructions)  # noqa: E501

        Get a docker install instructions for provided edge id.  Available for users with 'TENANT_ADMIN' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_edge_docker_install_instructions_using_get_with_http_info(edge_id, method, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_edge_docker_install_instructions_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'edge_id' is set
        if ('edge_id' not in params or
                params['edge_id'] is None):
            raise ValueError("Missing the required parameter `edge_id` when calling `get_edge_docker_install_instructions_using_get`")  # noqa: E501
        # verify the required parameter 'method' is set
        if ('method' not in params or
                params['method'] is None):
            raise ValueError("Missing the required parameter `method` when calling `get_edge_docker_install_instructions_using_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/edge/instructions/{edgeId}/{method}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
