...
class UserControllerApi(object):
    ...
    def get_users_by_ids(self, user_ids, **kwargs):  # noqa: E501
        """Get Users By Ids (getUsersByIds)  # noqa: E501

        Requested users must be owned by tenant or assigned to customer which user is performing the request.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_users_by_ids(user_ids, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_users_by_ids_with_http_info(user_ids, **kwargs)  # noqa: E501
        else:
            (data) = self.get_users_by_ids_with_http_info(user_ids, **kwargs)  # noqa: E501
            return data

    def get_users_by_ids_with_http_info(self, user_ids, **kwargs):  # noqa: E501
        """Get Users By Ids (getUsersByIds)  # noqa: E501

        Requested users must be owned by tenant or assigned to customer which user is performing the request.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_users_by_ids_with_http_info(user_ids, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_users_by_ids" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('user_ids' not in params or
            ...
            raise ValueError("Missing the required parameter `user_ids` when calling `get_users_by_ids`")  # noqa: E501
