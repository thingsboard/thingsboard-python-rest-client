...
class MobileAppControllerApi(object):
    ...
    def save_mobile_app_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        query_params = []
        if 'oauth2_client_ids' in params and params.get('oauth2_client_ids') is not None:
    ...
    def get_login_mobile_info(self, pkg_name, platform, **kwargs):  # noqa: E501
        """Get mobile app login info (getLoginMobileInfo)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_login_mobile_info(pkg_name, platform, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_login_mobile_info_with_http_info(pkg_name, platform, **kwargs)  # noqa: E501
        else:
            (data) = self.get_login_mobile_info_with_http_info(pkg_name, platform, **kwargs)  # noqa: E501
            return data

    def get_login_mobile_info_with_http_info(self, pkg_name, platform, **kwargs):  # noqa: E501
        """Get mobile app login info (getLoginMobileInfo)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_login_mobile_info_with_http_info(pkg_name, platform, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_login_mobile_info" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('pkg_name' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `pkg_name` when calling `get_login_mobile_info`")  # noqa: E501
        # verify the required parameter 'platform' is set
        if ('platform' not in params or
                params['platform'] is None):
            raise ValueError(
                "Missing the required parameter `platform` when calling `get_login_mobile_info`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/noauth/mobile{?pkgName,platform}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LoginMobileInfo',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_mobile_app_by_id(self, id, **kwargs):  # noqa: E501
        """Get mobile info by id (getMobileAppInfoById)  # noqa: E501

          Available for users with 'SYS_ADMIN' or 'TENANT_ADMIN' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_mobile_app_by_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_mobile_app_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_mobile_app_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_mobile_app_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get mobile info by id (getMobileAppInfoById)  # noqa: E501

          Available for users with 'SYS_ADMIN' or 'TENANT_ADMIN' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_mobile_app_by_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_mobile_app_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_mobile_app_by_id`")  # noqa: E501
    ...
    def get_tenant_mobile_apps(self, page_size, page, **kwargs):  # noqa: E501
        """Get mobile app infos (getTenantMobileAppInfos)  # noqa: E501

          Available for users with 'SYS_ADMIN' or 'TENANT_ADMIN' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_tenant_mobile_apps(page_size, page, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_tenant_mobile_apps_with_http_info(page_size, page, **kwargs)  # noqa: E501
        else:
            (data) = self.get_tenant_mobile_apps_with_http_info(page_size, page, **kwargs)  # noqa: E501
            return data

    def get_tenant_mobile_apps_with_http_info(self, page_size, page, **kwargs):  # noqa: E501
        """Get mobile app infos (getTenantMobileAppInfos)  # noqa: E501

          Available for users with 'SYS_ADMIN' or 'TENANT_ADMIN' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_tenant_mobile_apps_with_http_info(page_size, page, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['page_size', 'page', 'platform_type', 'text_search', 'sort_property', 'sort_order']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_tenant_mobile_apps" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'page_size' is set
        if ('page_size' not in params or
                params['page_size'] is None):
            raise ValueError(
                "Missing the required parameter `page_size` when calling `get_tenant_mobile_apps`")  # noqa: E501
        # verify the required parameter 'page' is set
        if ('page' not in params or
                params['page'] is None):
            raise ValueError(
                "Missing the required parameter `page` when calling `get_tenant_mobile_apps`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/mobile/app{?platformType,pageSize,page,textSearch,sortProperty,sortOrder}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PageDataMobileApp',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_user_mobile_info(self, pkg_name, platform, **kwargs):  # noqa: E501
        """Get user mobile app basic info (getUserMobileInfo)  # noqa: E501

          Available for any authorized user.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_mobile_info(pkg_name, platform, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_user_mobile_info_with_http_info(pkg_name, platform, **kwargs)  # noqa: E501
        else:
            (data) = self.get_user_mobile_info_with_http_info(pkg_name, platform, **kwargs)  # noqa: E501
            return data

    def get_user_mobile_info_with_http_info(self, pkg_name, platform, **kwargs):  # noqa: E501
        """Get user mobile app basic info (getUserMobileInfo)  # noqa: E501

          Available for any authorized user.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_mobile_info_with_http_info(pkg_name, platform, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_user_mobile_info" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'pkg_name' is set
        if ('pkg_name' not in params or
                params['pkg_name'] is None):
            raise ValueError(
                "Missing the required parameter `pkg_name` when calling `get_user_mobile_info`")  # noqa: E501
        # verify the required parameter 'platform' is set
        if ('platform' not in params or
                params['platform'] is None):
            raise ValueError(
                "Missing the required parameter `platform` when calling `get_user_mobile_info`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/mobile{?pkgName,platform}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='UserMobileInfo',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
