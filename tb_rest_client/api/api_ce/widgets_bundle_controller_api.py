...
class WidgetsBundleControllerApi(object):
    ...
    def get_widgets_bundles_by_ids(self, widgets_bundle_ids, **kwargs):  # noqa: E501
        ...
        Requested widgets bundles must be system level or owned by tenant of the user which is performing the request.     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_widgets_bundles_by_ids(widgets_bundle_ids, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_widgets_bundles_by_ids_with_http_info(widgets_bundle_ids, **kwargs)  # noqa: E501
        else:
            (data) = self.get_widgets_bundles_by_ids_with_http_info(widgets_bundle_ids, **kwargs)  # noqa: E501
            return data

    def get_widgets_bundles_by_ids_with_http_info(self, widgets_bundle_ids, **kwargs):  # noqa: E501
        """Get Widgets Bundles By Ids (getWidgetsBundlesByIds)  # noqa: E501

        Requested widgets bundles must be system level or owned by tenant of the user which is performing the request.     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_widgets_bundles_by_ids_with_http_info(widgets_bundle_ids, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_widgets_bundles_by_ids" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('widgets_bundle_ids' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `widgets_bundle_ids` when calling `get_widgets_bundles_by_ids`")  # noqa: E501
