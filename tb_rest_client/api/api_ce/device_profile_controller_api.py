...
class DeviceProfileControllerApi(object):
    ...
    def get_device_profile_infos_by_ids(self, device_profile_ids, **kwargs):  # noqa: E501
        """Get Device Profile Infos By Ids (getDeviceProfilesByIds)  # noqa: E501

        Requested device profiles must be owned by tenant which is performing the request.     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_device_profile_infos_by_ids(device_profile_ids, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_device_profile_infos_by_ids_with_http_info(device_profile_ids, **kwargs)  # noqa: E501
        else:
            (data) = self.get_device_profile_infos_by_ids_with_http_info(device_profile_ids, **kwargs)  # noqa: E501
            return data

    def get_device_profile_infos_by_ids_with_http_info(self, device_profile_ids, **kwargs):  # noqa: E501
        """Get Device Profile Infos By Ids (getDeviceProfilesByIds)  # noqa: E501

        Requested device profiles must be owned by tenant which is performing the request.     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_device_profile_infos_by_ids_with_http_info(device_profile_ids, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_device_profile_infos_by_ids" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('device_profile_ids' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `device_profile_ids` when calling `get_device_profile_infos_by_ids`")  # noqa: E501
