...
class TbResourceControllerApi(object):
    ...
    def get_lwm2m_list_objects_page_using_get(self, page_size, page, **kwargs):  # noqa: E501
        """getLwm2mListObjectsPage  # noqa: E501
    ...
    def get_lwm2m_list_objects_page_using_get_with_http_info(self, page_size, page, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/resource/lwm2m/page{?pageSize,page,textSearch,sortProperty,sortOrder}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_lwm2m_list_objects_using_get(self, sort_order, sort_property, **kwargs):  # noqa: E501
        """getLwm2mListObjects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_lwm2m_list_objects_using_get(sort_order, sort_property, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str sort_order: sortOrder (required)
        :param str sort_property: sortProperty (required)
        :param list[str] object_ids: objectIds
        :return: list[LwM2mObject]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_lwm2m_list_objects_using_get_with_http_info(sort_order, sort_property, **kwargs)  # noqa: E501
        else:
            (data) = self.get_lwm2m_list_objects_using_get_with_http_info(sort_order, sort_property, **kwargs)  # noqa: E501
            return data

    def get_lwm2m_list_objects_using_get_with_http_info(self, sort_order, sort_property, **kwargs):  # noqa: E501
        """getLwm2mListObjects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_lwm2m_list_objects_using_get_with_http_info(sort_order, sort_property, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/resource/lwm2m{?sortOrder,sortProperty,objectIds}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_resources_using_get_with_http_info(self, page_size, page, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/resource{?pageSize,page,textSearch,sortProperty,sortOrder}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
